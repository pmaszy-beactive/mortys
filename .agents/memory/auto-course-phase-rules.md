...
- Phase 3 unlock: completing Theory #8 immediately unlocks Theory #9, Theory #10, and every In-Car #5–#10; these remaining sessions may be booked and completed in any order.
- A two-hour Phase 3 In-Car #5/#6 appointment is two distinct 60-minute classes and enrollments, scheduled back-to-back with the same instructor and booked atomically. Never model it as one 120-minute row.
...
**How to apply:** never require Theory #9 or sequential in-car completion within Phase 3. Keep Theory #8 as the sole opener, while retaining duplicate, concurrency, daily-hours, and Phase 4 gates. Phase 3 class rows #5–#10 must each be 60 minutes.
