...
description: Source of truth for the auto (car) 4-phase curriculum rules and where they're enforced; moto/scooter use the simplified 2-phase model.
---

The 4-phase curriculum documents (12 theory + 15 in-car, 28/28/56/56-day phase minimums) apply to the **auto (car) course only**. Moto = 7 theory + 10 riding, scooter = 6 + 8, both simplified 2-phase (all theory before practical), confirmed by the user Aug 2026.
